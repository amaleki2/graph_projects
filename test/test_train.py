...
from src import GatUNet2, GraphNetworkIndependentBlock, GraphNetworkBlock, EncodeProcessDecodeNEW  # networks
from src import borderless_loss, clamped_loss, deep_mind_loss, level_set_loss  # losses
...
train_sdf(model, train_data, train_data, loss_funcs, n_epoch=2, use_cpu=True, save_name=save_name, **losses_params)
...
train_sdf(model, train_data, train_data, loss_funcs, n_epoch=2, use_cpu=True, save_name=save_name)
